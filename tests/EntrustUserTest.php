...
use Hwacom\Entrust\Contracts\EntrustUserInterface;
use Hwacom\Entrust\Traits\EntrustUserTrait;
use Illuminate\Cache\ArrayStore;
use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Cache;
use Hwacom\Entrust\Permission;
use Hwacom\Entrust\Role;
use Mockery as m;
...
class EntrustUserTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $permMock = m::mock('Hwacom\Entrust\Permission');
    ...
    {
        $roleMock = m::mock('Hwacom\Entrust\Role');
